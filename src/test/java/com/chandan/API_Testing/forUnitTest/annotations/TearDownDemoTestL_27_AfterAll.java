...
//L-27
public class TearDownDemoTestL_27_AfterAll {
    ...
    @AfterAll  //it will execute at once
    static void tearDownMethodDemoTest(){ //here @AfterAll method should be static,
        //this method is basically closing  the connection of database or closing the variable which all ready oped at all shared test resources
        calculator=null;
        System.out.println("calling tearDown method once");
